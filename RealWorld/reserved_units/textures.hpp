...
const RE::TextureUnit TEX_UNIT_TILE_TRANSLU = {6};			/**< Texture unit reserved for translucency of tiles */
const RE::TextureUnit TEX_UNIT_SHADOWS = {7};				/**< Texture unit reserved for calculated shadows */
