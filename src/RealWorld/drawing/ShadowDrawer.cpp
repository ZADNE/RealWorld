...
ShadowDrawer::ShadowDrawer(
    ...
    , m_(viewSizePx, viewSizeTi, m_analysisPll, m_calculationPll,
...
void ShadowDrawer::resizeView(glm::vec2 viewSizePx, glm::ivec2 viewSizeTi) {
    m_ = ViewSizeDependent{viewSizePx,          viewSizeTi,
                           m_analysisPll,       m_calculationPll,
...
void ShadowDrawer::analyze(
    ...
    cb->pushConstants<AnalysisPC>(*m_analysisPll, eCompute, 0u, m_.analysisPC);
    cb->dispatch(
...
ShadowDrawer::ViewSizeDependent::ViewSizeDependent(
    ...
    const re::PipelineLayout& analysisPll, const re::PipelineLayout& calculationPll,
