...
constexpr std::array<glm::uvec4, 23> k_wallTransformationRules = {
//              REQUIRED properties of neighbors        FORBIDDEN properties of neighbors       RULE's properties                   TARGET tile
    ...
    glm::uvec4{ HALLOWb,                                0,                                      1023 | MIX_PROPSb,                   Wall::HallowDirt},      // Hallow dirt
    glm::uvec4{ BURNINGb,                               EXTINGUISHINGb,                         1023 | MIX_PROPSb | TO_OTHERb,       Block::Fire},           // Burning of leaf
    glm::uvec4{ 0,                                      0,                                      63   | EDGEb | TO_OTHERb,            Block::DroppedLeaf},    // Leaf drop
    glm::uvec4{ BURNINGb,                               EXTINGUISHINGb,                         1023 | MIX_PROPSb | TO_OTHERb,       Block::Fire},           // Burning of dry leaf
