...
constexpr std::array<glm::uvec4, 18> k_wallTransformationRules = {
//              REQUIRED properties of neighbors        FORBIDDEN properties of neighbors       RULE's properties                   TARGET tile
    ...
    glm::uvec4{ HALLOWb,                                0,                                      MIX_PROPSb,                         Wall::HallowDirt},      // Hallow dirt
    glm::uvec4{ 0,                                      0,                                      EDGEb | TO_OTHERb | LOW_VARb,       Block::DroppedLeaf},    // Leaf drop
    glm::uvec4{ 0,                                      0,                                      EDGEb | TO_OTHERb | LOW_VARb,       Block::DroppedDryLeaf}, // Dry leaf drop
};
