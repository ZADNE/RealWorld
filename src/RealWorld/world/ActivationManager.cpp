...
void ActivationManager::beginStep() {
...
void ActivationManager::planActivationOfArea(
...
void ActivationManager::endStep(const re::CommandBuffer& cmdBuf) {
...
void ActivationManager::planTransition(
